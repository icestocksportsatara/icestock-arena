...
/** Auth responses (tokens, session state) must never be cached by a proxy or browser. */
...
module.exports = { helmetConfig, generalLimiter, loginLimiter, hppMiddleware: hpp(), sanitizeBody, noStore };
