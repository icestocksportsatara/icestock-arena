...
/**
 * POST /api/auth/login
 * All roles (SUPER_ADMIN, COUNTRY_HEAD, STATE_HEAD, DISTRICT_HEAD,
 * REFEREE, PLAYER) authenticate through this single endpoint; the
 * role on the account determines what the frontend renders next.
 */
router.post(
  '/login',
  loginLimiter,
