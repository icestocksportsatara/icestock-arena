...
import PublicLiveHome from './pages/public/PublicLiveHome';
import PublicTournamentLive from './pages/public/PublicTournamentLive';
...
function RoleHome() {
  const { user } = useAuth();
  // Signed-out visitors land on the public live-scoreboard homepage
  // (with the 3D hero) instead of being pushed straight to a login wall.
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/live" element={<PublicLiveHome />} />
      <Route path="/live/:tournamentId" element={<PublicTournamentLive />} />
